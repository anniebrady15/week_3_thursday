...
plastic_waste %>% 
  ggplot(aes(x = plastic_waste_per_cap , y = )) +
  geom_histogram() +
...
plastic_waste %>% 
  ggplot(aes(x = plastic_waste_per_cap, 
             ...
             colour = continent)) +
  geom_point()
#weakly correlated, as plastic waste increases, so does mismanagement
```
...
#Europe and Asia have lower rates of mismanagement. Africa and Oceania have higher rates with lower amounts of waste. North American and South America are in the middle
...
#replaced too large T&T value of 3.6, assumed was error, made it 0.6
edit <- plastic_waste %>%
  mutate(plastic_waste_per_cap = replace(plastic_waste_per_cap, plastic_waste_per_cap == 3.6, 0.6))
