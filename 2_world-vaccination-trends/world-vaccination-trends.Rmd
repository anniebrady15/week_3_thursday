...
Vaccines <- read.csv(here("data", "world_vaccination.csv")) 
...
world_vacc_plot <- world_vaccination %>% 
  ggplot(aes(x = yr,
             y = pct_vaccinated,)) +
  geom_point() +
  labs(x = "Year", y = "Percentage of People Vaccinated")
```
...
world_vacc_plot <- world_vaccination %>% 
  ggplot(aes(x = yr,
             y = pct_vaccinated, colour = vaccine , shape = vaccine)) +
  geom_point() +
  labs(x = "Year", y = "Percentage of People Vaccinated")
```
...
polio_regions <- polio %>% 
  ggplot(aes(x = yr,
             y = pct_vaccinated, colour = who_region , shape = who_region)) +
  geom_point() +
  labs(x = "Year", y = "Percentage of People Vaccinated")
```
...
polio_regions_line<- polio %>% 
  ggplot(aes(x = yr,
             y = pct_vaccinated, colour = who_region , )) +
  geom_line() +
  labs(x = "Year", y = "Percentage of People Vaccinated")
...
polio_regions_line<- polio %>% 
  ggplot(aes(x = yr,
             y = pct_vaccinated, colour = who_region , )) +
  geom_line() +
  labs(x = "Year", y = "Percentage of People Vaccinated", colour = "Region")
```
...
```{r}
hep_b <- world_vaccination %>% 
  filter(vaccine == "hepatitis_b")

comparison <- world_vaccination %>% 
  ggplot(aes(x = yr,
             y = pct_vaccinated, colour = who_region)) +
  geom_line() +
  labs(x = "Year", y = "Percentage of People Vaccinated", colour = "region")+
